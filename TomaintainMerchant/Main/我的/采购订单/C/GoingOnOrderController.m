...
@interface GoingOnOrderController ()<UITableViewDataSource,UITableViewDelegate,OrderPayQuitFooterViewDelegate>
{
...
@implementation GoingOnOrderController
...
- (void)downLoadData{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@?stationId=%@&token=%@&status=%@",orderList,stationId,token,@"1"];
