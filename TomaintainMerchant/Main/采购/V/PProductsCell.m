...
//        UILabel *memberPriceLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(image.frame) + GAP, CGRectGetMaxY(priceLabel.frame ) + GAP, 100, (ViewHeight - 4 * GAP)/4)];
...
//        [self addSubview:memberPriceLabel];
        ...
        UILabel *buyLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN.width - 120, ImgWidth - 35, 110, 35)];
        buyLabel.text = @"加入购物车";
...
//    _memberPriceLabel.text = [NSString stringWithFormat:@"会员价：%@",_model.vipPprice];
