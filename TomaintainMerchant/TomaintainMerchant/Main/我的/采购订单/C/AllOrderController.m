...
@interface AllOrderController ()<UITableViewDataSource,UITableViewDelegate,OrderPayQuitFooterViewDelegate>
{
...
- (void)downLoadData{
    ...
    NSString * urlStr = [NSString stringWithFormat:@"%@?stationId=%@&token=%@",orderList,stationId,token];
